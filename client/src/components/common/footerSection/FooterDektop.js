                    ...
                    <Container fluid={true}>
                        <Row className={'px-0 my-5'}>
                            <Col lg={3} md={3} sm={6} xs={12}>
                                ...
                                <a href={sessionStorage.getItem("f_tw")} className={'footer-link'}><img src={twitterIcon} className={'iconGeneral'}/></a>
                            </Col>
                            ...
                            <Col lg={3} md={3} sm={6} xs={12}>
                                ...
                                <p>{sessionStorage.getItem('f_address')}</p>

                            </Col>

                            <Col lg={3} md={3} sm={6} xs={12}>
                                <h5 className={'footer-menu-title'}>DOWNLOAD APP</h5>
                                <a href={sessionStorage.getItem("f_ios")} className={"footer-link"}><img src={appleStore} className={'iconGeneral'}/></a> <br/>
